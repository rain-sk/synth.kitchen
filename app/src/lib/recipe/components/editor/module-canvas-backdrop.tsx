...
> = ({
	...
	const onDrag = useCallback(
		(e: MouseEvent) => {
			...
			dispatch(
				recipeActions.selectionDragContinueAction(selection.current.end),
			);
		},
		[dispatch],
	);
	...
	const onMouseUp = useCallback(
		(e: MouseEvent) => {
			dispatch(
				recipeActions.selectionDragEndAction(
	...
	const onMouseDown = useCallback(
		(e: ReactMouseEvent<HTMLDivElement>) => {
			...
			dispatch(recipeActions.selectionDragStartAction(position));
