...
const useDragAndDrop = (
	...
	const updateModulePosition = useCallback(
		(position: Position) => {
			dispatch(recipeActions.updateModulePositionAction(moduleKey, position));
		},
		[dispatch, moduleKey],
	);
...
> = ({
	...
	const onFocus = useCallback(() => {
		dispatch(recipeActions.selectSingleModuleAction(module.moduleKey));
	...
	const onMouseDown = useCallback(
		(e: React.MouseEvent<HTMLDivElement>) => {
			...
			if (!shiftClick && !currentlySelected) {
				...
				dispatch(recipeActions.deselectModuleAction(module.moduleKey));
			} else if (shiftClick && !currentlySelected) {
				dispatch(recipeActions.selectModuleAction(module.moduleKey));
			}
