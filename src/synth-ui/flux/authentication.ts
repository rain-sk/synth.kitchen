...
export const [reducers, AuthenticationStore, AuthenticationProvider] = createFlux<AuthenticationAction, IAuthenticationState>({ authenticated: false, isLoggingIn: false, isRegistering: false });
