...
import example1 from '../../assets/home-example-1.png';
import example2 from '../../assets/home-example-2.png';
				...
				<main className="page-home">
					<section>
						<article id="intro" className="light">
							<h2>A web-based modular synthesis environment</h2>
							<p>Because what else are you doing during quarantine?</p>
						</article>
					</section>

					<section>
						<article id="why">
							<h2>Why make a modular synth website?</h2>
							<dl>
								<dt>Portable</dt>
								...
								<dt>Accessible</dt>
								<dd>
									Browsers have straightforward, well-documented accessibility
									support
								</dd>
							</dl>
						</article>
						...
						<article id="example" className="light">
							...
							<figure>
								...
								<figcaption>
									<i>
										Modules can be added and connected in limitless variations
									</i>
								</figcaption>
							</figure>
							<figure className="img-right">
								...
								<figcaption>
									<i>
										Connect to your MIDI hardware/software (requires
										Chrome/Edge)
									</i>
								</figcaption>
							</figure>
					...
					<p>
						Want to try it out? Open the <Link to="/patch">patch editor</Link>.
					</p>
				</main>
			</div>
		);
