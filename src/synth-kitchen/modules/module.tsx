...
import { IModule, useDispatch } from '../state';

const useDragAndDrop = (initialX: number, initialY: number, containerRef: React.MutableRefObject<HTMLElement | null>, onUpdate: (x: number, y: number) => void) => {
...
export const Module: React.FunctionComponent<{ module: IModule}> = ({ module }) => {
    ...
    const onMouseDown = useDragAndDrop(module.x, module.y, containerRef, onUpdatePosition);
