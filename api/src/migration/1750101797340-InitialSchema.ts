...
export class InitialSchema1750101797340 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "recipe" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "data" json NOT NULL, "public" boolean NOT NULL DEFAULT false, "chefId" uuid, "forkedFromId" uuid, CONSTRAINT "PK_e365a2fedf57238d970e07825ca" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "recipe" ADD CONSTRAINT "FK_baaad01dd4f9d161db19a27ca4d" FOREIGN KEY ("forkedFromId") REFERENCES "recipe"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "recipe" DROP CONSTRAINT "FK_baaad01dd4f9d161db19a27ca4d"`
    );
    await queryRunner.query(
