...
export interface ApiPatchPatch extends Struct.CollectionTypeSchema {
  collectionName: 'Patches_v1';
  info: {
    description: '';
    displayName: 'Patch';
    pluralName: 'patches';
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    patches: Schema.Attribute.Relation<'oneToMany', 'api::patch.patch'>;
