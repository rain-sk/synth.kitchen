...
RUN npm uninstall @types/bcrypt @types/cors @types/express @types/node concurrently esbuild ts-node typescript class-validator cors pg pg-hstore reflect-metadata synth.kitchen-shared
